...
namespace {
  void PrintUsage() {
    G4cerr << " Usage: " << G4endl;
    G4cerr << " exampleBasic [-m macro ] [-u UIsession] [-t nThreads]" << G4endl;
...
int main(int argc,char** argv)
{
  ...
  //
  auto detConstruction = new BasicDetectorConstruction();
  ...
  auto actionInitialization = new BasicActionInitialization();
